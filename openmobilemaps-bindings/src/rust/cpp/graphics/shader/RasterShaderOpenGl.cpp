...
std::string RasterShaderOpenGl::getProgramName() { return "UBMAP_RasterShaderOpenGl"; }
...
std::shared_ptr<ShaderProgramInterface> RasterShaderOpenGl::asShaderProgramInterface() { return shared_from_this(); }
